...
export class RSA {
    ...
    public verifyDigitalSignature(text: string, digitalSign: BigInteger, e: BigInteger, n: BigInteger): boolean {
        const signBytes: BigInteger = digitalSign.modPow(e, n);
