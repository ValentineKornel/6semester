...
internal class Program
{
    ...
    {
        string CS = "Data Source=DESKTOP-0M3BPJP;Initial Catalog=Temp;Integrated Security=True;Trust Server Certificate=True";
        ...
        using (IRepostory repo = Repository.Create(CS))
        {
            {
            ...
            }
            {
                ...
                if ((id = repo.GetCelebrityIdByName("Einstein")) > 0)
                {
                    ...
                    {
                        printC(c);
                        if (!repo.DeleteCelebrity(id)) Console.WriteLine($"ERROR: DelCelebrity: {id}");
            ...
            }
            {
                ...
                int id = 22;
                if (repo.DeleteLifeevent(id)) Console.WriteLine($"OK: DelLifeevent: {id}");
            ...
            }
            {
                ...
                if ((l1 = repo.GetLifeeventById(id)) != null)
                {
                    ...
                    if (repo.UpdateLifeevent(id, l1)) Console.WriteLine($"OK:UpdLifeevent {id}, {printL(l1)}");
